...
if restart_request ~= nil then
    ...
    M.current = file:read("*all")
end

function M.launch_selector()
    local targets = M.get_launch_targets()
    local opts = {
