...
- `build_agent_instructions() -> str`: Builds `claude/CLAUDE.md` as one file for Codex and Copilot, with the writing examples inlined in place of their `@` import and the output style appended.
